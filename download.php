<?php
/**
 * Download a BigBlueButton record
 *
...
// Output starts here.
$aux = explode('/playback/',$url);
$arquivo = $aux[0].'/presentation/'.$_GET['recordID'].'/video/webcams.mp4?token='.$token;
echo $arquivo;
//echo '<meta http-equiv="refresh" content="0; url='.$arquivo.'">';
//$arquivo = $url."&token=".$token;
